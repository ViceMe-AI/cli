...
Only an Admin-approved active creator merchant can author Products. If there is
no account, stop and explain that Admin must enable creator status. If multiple
accounts are ever returned, show them and ask which one owns this Work. Do not
