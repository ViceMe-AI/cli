...
- sell-a-skill 上架文案字数同步到 100/500 (`baf06be`)

## [0.47.0] - 2026-09-23

### Features

- 支持导出带简介的小红书渠道包 (`34948b0`)

### Fixes

- 购买渠道包保留原始 Skill 名称和简介 (`d92f9b7`)
...
- 记录最新支付流程基线同步 (`e37a94d`)
- 更新配套 PR 与合并前交付状态 (`8d8410d`)
- 记录最新分支的完整验收结果 (`73214c2`)
- 明确运营身份来源发布和官方包边界 (`e9a25bb`)
...
- 试用门禁补无 CLI 时的安装引导 (`f9a6640`)

## [0.26.3] - 2026-09-03

### Fixes

- 完整恢复 Skill 报价订单与支付流程 (`5390a5a`)
