...
| `viceme website publish --path <目录> --name <名称> [--url <网址>] [--description-zh-cn ...] [--description-en-us ...] [--cover-url <网址>]` | 使用可选的 Agent 审核描述和封面发布网站作品；重复发布复用 `.viceme/website.json` 中的同一作品身份。 |
