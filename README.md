...
| `viceme website publish --path <dir> --name <name> [--url <url>] [--description-zh-cn ...] [--description-en-us ...] [--cover-url <url>]` | Publish a website work with optional Agent-reviewed descriptions and cover; repeat publication reuses the identity in `.viceme/website.json`. |
